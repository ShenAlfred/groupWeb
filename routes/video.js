...
var videoList = function() {
    return new Promise(function(resolve, reject) {
        var req = http.get(config.baseUrl + '/api/videoList/?pageSize=6&iPage=1', function(req, res) {
            ...
            req.on('end', function(){
                ...
                contentDetail.level2_name = 'video';
...
router.get('/', function(req, res, next) {
    ...
    request.navigationBar().then(function(navigationBar) {
        ...
        videoList().then(function(contentDetail) {
            res.render('mainview/video', Object.assign(
                {
                    content: contentDetail,
                    navigationBar: navigationBar,
                    activeIndex: activeIndex,
                    activeIndex_two: activeIndex_two,
                    wherePage: 'news-video'
                },config.tdk[key]
            ));
        })
    })
